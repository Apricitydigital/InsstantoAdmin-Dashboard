...
export default function SlotAvailabilityPage() {
  ...
  return <div className="space-y-6 p-4 md:p-6">
    ...
    <p className="rounded-lg border bg-muted/30 p-3 text-sm text-muted-foreground">Each event is an unavailable slot-screen occurrence, not a unique customer. Customer details are shown when the event contains a customer reference or UID; older events may not identify a customer.</p>
